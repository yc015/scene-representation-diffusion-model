        ...
        for block_ind in range(i_s, i_e):
            ...
            for layer_ind in range(layer_range):
                ...
                plt_test_results_continuous_depth(probe,
                                                  ...
                                                  head=None, save_plt=True, norm_output=False,
                                                  save_filename=f"probe_accuracy/large_syn_dataset_continuous/at_step_{at_step}/saved_test_results_{block}_{block_ind}_layer_{layer_ind}_{postfix}{weights_postfix}.png")
